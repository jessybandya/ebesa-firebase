  ...
  return (
    ...
    <Box sx={{ bgcolor: 'background.paper' }}>
      ...
      >
        ...
        <Viewevent description={post?.description} title={post?.title} venue={post?.venue} date={post?.date} status={post?.status} id={post?.id}/>
        </TabPanel>
    ...
    {submitComment === "" ?(
        ...
        <SendOutlined onClick={submitCommentFun} style={{marginRight:20,marginLeft:3,cursor:'pointer',fontSize:'20px',color:'#43a047'}}/>
    )}
    </div>
     </center>
    ): value === 0 ?(
        ...
        {post?.status === true ?(
            ...
            {auth?.currentUser?.uid ?(
                <Button onClick={authFun} style={{backgroundColor:'#43a047', border:'1px solid #43a047',color:'#fff'}} variant="contained">
                {loading === true ?(
                ...
                <Button onClick={() => setModalShow1(true)} style={{backgroundColor:'#43a047', border:'1px solid #43a047',color:'#fff'}} variant="contained">
                {loading === true ?(
                  <span><span style={{color:'#fff'}}>attending...<Spin size="middle" /></span></span>
                ):(
                  <span>Attend</span>
         ...
         <Button style={{backgroundColor:'#43a047', border:'1px solid #43a047',color:'#fff'}} variant="contained">
