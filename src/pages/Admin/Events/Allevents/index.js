      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        <Table stickyHeader aria-label="sticky table">
          <TableHead sx={{ display: "table-header-group" }}>
            ...
            <TableCell style={{minWidth:100,fontSize:13,backgroundColor: "#43a047",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">REVIEWS</TableCell>
            <TableCell style={{minWidth:100,fontSize:13,backgroundColor: "#43a047",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">ATTENDANCE</TableCell>
            <TableCell style={{minWidth:100,fontSize:13,backgroundColor: "#43a047",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">GALLERY</TableCell>
            <TableCell style={{minWidth:100,fontSize:13,backgroundColor: "#43a047",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">STATUS</TableCell>
            <TableCell style={{minWidth:100,fontSize:13,backgroundColor: "#43a047",fontWeight:"900",borderBottom: "2px solid #fff",color:"#fff"}} align="right">VIEW</TableCell>
